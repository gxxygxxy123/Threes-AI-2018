...
public:
	/**
	 * show the statistic of last 'block' games in Threes
	 *
	 * the format would be
	 * 1000   avg = 123, max = 456, ops = 241563 (170543|896715)
	 *        12     100%   (0.3%)
	 *        24    99.7%  (0.2%)
	 *        48    99.5%  (1.1%)
	 *        96    98.4%  (4.7%)
	 ...
	 *  'avg = 123': the average score is 123
	 *  'max = 456': the maximum score is 456
	 ...
	 *  '93.7%': 93.7% (937 games) reached 192-tiles (a.k.a. win rate of 192-tile)
	 *  '22.4%': 22.4% (224 games) terminated with 192-tiles
	 */
